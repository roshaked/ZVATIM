const questions = [
  ...
  },
  {
    ...
    question: "לפי שיעור 1, מה מסביר בצורה הטובה ביותר למה ארגונים זקוקים כיום לצוותים?",
    options: [
      { text: "גלובליזציה, טכנולוגיה, תחרות, צורך בחדשנות וארגונים שטוחים יוצרים משימות מורכבות שמחייבות שיתוף פעולה.", correct: true },
      { text: "כדי שכל עובד יעבוד לבד בלי תלות באחרים ובלי צורך בתיאום.", correct: false },
      { text: "כדי להחזיר את הארגון למבנה היררכי קשיח שבו רק מנהל אחד מקבל החלטות.", correct: false },
      { text: "כי צוותים חשובים רק לצרכים חברתיים ואין להם קשר לביצועים או חדשנות.", correct: false }
    ],
    explanation: "שיעור 1 והסיכום הכולל מציגים את הצוות כמענה לעולם עבודה גלובלי, טכנולוגי, תחרותי ופחות היררכי."
  },
  {
    topic: "עולם העבודה המודרני",
    question: "מהי Globalization - גלובליזציה בהקשר של שיעור 1?",
    options: [
      { text: "התרחבות קשרים עסקיים וחברתיים בין מדינות, אנשים וארגונים באופן שמצמצם מגבלות מרחק וזמן.", correct: true },
      { text: "החלטה שכל העובדים בארגון חייבים לעבוד מאותו חדר ובאותן שעות.", correct: false },
      { text: "צמצום מוחלט של קשרים בין ארגונים כדי להגן על ידע פנימי.", correct: false },
      { text: "תהליך שבו צוותים מפסיקים להשתמש בטכנולוגיה כדי לשמור על קשר אישי בלבד.", correct: false }
    ],
    explanation: "החומר מדגים עולם שבו שירותים, ידע ועבודה יכולים להתרחש מעבר לגבולות גיאוגרפיים."
  },
  {
    topic: "עולם העבודה המודרני",
    question: "מה הקשר בין Flat Organizations - ארגונים שטוחים לבין עבודה בצוותים?",
    options: [
      { text: "כאשר מפחיתים שליטה היררכית ומעבירים סמכויות, צוותים נדרשים לפתור בעיות ולקבל החלטות יחד.", correct: true },
      { text: "ארגון שטוח הוא ארגון שבו אין צורך בתיאום כי כל אחד עושה פעולה פשוטה ומבודדת.", correct: false },
      { text: "ארגון שטוח מחזק רק פיקוח צמוד ולכן מצמצם עבודת צוות.", correct: false },
      { text: "אין קשר בין מבנה הארגון לבין הצורך בצוותים.", correct: false }
    ],
    explanation: "בסיכום שיעור 1 מופיע מעבר מארגונים היררכיים ושליטה הדוקה לצוותים חוצי תחומים ורמות היררכיה."
  },
  {
    topic: "סוגי צוותים",
    question: "מה מאפיין Advice / Consulting Team - צוות ייעוץ לפי ההשלמה המקיפה?",
    options: [
      { text: "צוות מומחים שמנתח סוגיות מורכבות ומגיש המלצות או חוות דעת, בלי לעסוק בייצור שוטף.", correct: true },
      { text: "צוות שמבצע משימת חירום בזמן אמת לפי פרוטוקולים נוקשים.", correct: false },
      { text: "צוות קבוע שמבצע עבודה שגרתית יומית בתוך מחלקה אחת.", correct: false },
      { text: "צוות שמטרתו היחידה היא יצירת אווירה חברתית בלי החלטות מקצועיות.", correct: false }
    ],
    explanation: "צוות ייעוץ מוגדר כצוות מומחים שממוקד במחקר, ניתוח והמלצות להנהלה או ליחידות אחרות."
  },
  {
    topic: "פרמטרים להשוואת צוותים",
    question: "מה מודד Degree of Cooperation - מידת שיתוף פעולה?",
    options: [
      { text: "את רמת התלות ההדדית והסנכרון הנדרשים בפועל בין חברי הצוות כדי להשלים את המשימה.", correct: true },
      { text: "את מספר הפגישות החברתיות שאינן קשורות למשימה.", correct: false },
      { text: "את כמות המנהלים שמפקחים על הצוות.", correct: false },
      { text: "את מידת הוותק האישי של כל חבר צוות בלבד.", correct: false }
    ],
    explanation: "ההשלמה מציגה רצף בין שיתוף פעולה נמוך, שבו העבודה עצמאית יחסית, לבין שיתוף פעולה גבוה שמחייב סנכרון בזמן אמת."
  },
  {
    topic: "העצמה",
    question: "מהם רכיבים של Empowerment - העצמה לפי ההשלמה?",
    options: [
      { text: "משמעות, אוטונומיה, תחושת מסוגלות ויכולת השפעה.", correct: true },
      { text: "פיקוח צמוד, הוראות קטנות וחוסר יכולת להשפיע.", correct: false },
      { text: "רק תגמול כספי בלי קשר למשמעות או אוטונומיה.", correct: false },
      { text: "שייכות לקבוצה בלי אפשרות לקבל החלטות.", correct: false }
    ],
    explanation: "ההשלמה מחברת העצמה לתחושת משמעות, מסוגלות, אוטונומיה והשפעה."
  },
  {
    topic: "העצמה",
    question: "מה ההבדל בין Theory X - תיאוריית X לבין Theory Y - תיאוריית Y?",
    options: [
      { text: "Theory X מניחה שאנשים עצלים ולכן מובילה למיקרו-ניהול; Theory Y מניחה שאנשים שואפים לאחריות ולכן מאפשרת אוטונומיה.", correct: true },
      { text: "Theory X מעודדת אוטונומיה מלאה, ו-Theory Y מחייבת פיקוח צמוד.", correct: false },
      { text: "שתיהן עוסקות רק בשכר ואין להן קשר לניהול צוותים.", correct: false },
      { text: "שתיהן אומרות שאין צורך במנהלים בצוותים.", correct: false }
    ],
    explanation: "ההשלמה מציגה את ההנחות הניהוליות כבסיס להעצמה או למיקרו-ניהול."
  },
  {
    topic: "FISH",
    question: "מהו The Something Extra - הדבר הנוסף בפילוסופיית FISH?",
    options: [
      { text: "האנרגיה החיובית, ההתלהבות והכיף שעובדים בוחרים להביא לעבודה מעבר למשימה הטכנית.", correct: true },
      { text: "תקציב נוסף שמאפשר לגייס עובדים חדשים.", correct: false },
      { text: "כלי מדידה כמותי שמחשב כמה לקוחות התקשרו ביום.", correct: false },
      { text: "נוהל פורמלי שמחייב כל עובד לעבוד לבד.", correct: false }
    ],
    explanation: "ב-FISH הדגש הוא על בחירה בגישה ונוכחות שמטעינות את העבודה במשמעות וגאווה."
  },
  {
    topic: "FISH",
    question: "איזה עיקרון אינו אחד מארבעת עקרונות FISH כפי שמופיעים בהשלמה?",
    options: [
      { text: "Micromanage Everyone - לנהל כל אחד במיקרו.", correct: true },
      { text: "Choose Your Attitude - לבחור את הגישה שלך.", correct: false },
      { text: "Be Present - להיות נוכח.", correct: false },
      { text: "Make Their Day - לעשות להם את היום.", correct: false }
    ],
    explanation: "ארבעת העקרונות הם Play - לשחק, Choose Your Attitude - לבחור גישה, Make Their Day - לעשות להם את היום, ו-Be Present - להיות נוכח."
  },
  {
    topic: "נורמות",
    question: "לפי Schein Iceberg Model - מודל הקרחון של שיין, מהי הרמה העמוקה ביותר בתרבות הארגונית?",
    options: [
      { text: "Basic Assumptions - הנחות יסוד עמוקות ולא תמיד מודעות.", correct: true },
      { text: "Artifacts - ארטיפקטים גלויים בלבד.", correct: false },
      { text: "Espoused Values - ערכים מוצהרים בלבד.", correct: false },
      { text: "כמות הישיבות השבועיות של הצוות.", correct: false }
    ],
    explanation: "שיין מבחין בין ארטיפקטים גלויים, ערכים מוצהרים והנחות יסוד עמוקות שמפעילות התנהגות בפועל."
  },
  {
    topic: "Groupthink",
    question: "איזה כלי מוצע בהשלמה כדי לצמצם Groupthink - חשיבת קבוצה?",
    options: [
      { text: "Devil's Advocate - פרקליט השטן, שתפקידו לערער ולשאול שאלות ביקורתיות.", correct: true },
      { text: "להימנע מכל ביקורת כדי לשמור על הרמוניה.", correct: false },
      { text: "להחליט תמיד לפי דעת הרוב הראשונה שעולה.", correct: false },
      { text: "להוציא מהדיון את מי שמעלה ספק.", correct: false }
    ],
    explanation: "ההשלמה מציינת עידוד ביקורת ומינוי פרקליט השטן ככלים נגד חשיבת קבוצה."
  }
];
...
const terms = [
  ...
  { en: "Globalization", he: "גלובליזציה", source: "materials.html#modern-work", sourceNote: "שיעור 1 + סיכום נוטבוק, עמוד 1", note: "התרחבות קשרים עסקיים וחברתיים בין מדינות, אנשים וארגונים, באופן שמצמצם מגבלות זמן ומרחק." },
  { en: "Technology", he: "טכנולוגיה", source: "materials.html#modern-work", sourceNote: "שיעור 1", note: "אמצעים דיגיטליים שמאפשרים עבודה מרחוק, תקשורת מהירה ושיתופי פעולה מורכבים." },
  { en: "Flat Organizations", he: "ארגונים שטוחים", source: "materials.html#modern-work", sourceNote: "שיעור 1 + סיכום נוטבוק, עמוד 1", note: "ארגונים שמפחיתים שליטה היררכית ומעבירים יותר אחריות וסמכות לצוותים." },
  { en: "Advice / Consulting Team", he: "צוות ייעוץ", source: "materials.html#advice-team", sourceNote: "השלמה מקיפה, עמודים 3 ו-7", note: "צוות מומחים שמנתח סוגיות מורכבות ומגיש המלצות, חוות דעת או הצעות להחלטה; אינו עוסק בייצור שוטף." },
  { en: "Degree of Cooperation", he: "מידת שיתוף פעולה", source: "materials.html#team-comparison", sourceNote: "השלמה מקיפה, עמודים 3-4", note: "רמת התלות ההדדית הנדרשת בפועל בין חברי הצוות, מרמה נמוכה של עבודה עצמאית ועד סנכרון בזמן אמת." },
  { en: "FISH!", he: "פילוסופיית הדג", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמודים 4 ו-6-7", note: "גישה המדגישה בחירה באנרגיה חיובית, נוכחות, משחקיות ועשיית היום לאחרים גם בעבודה שוחקת." },
  { en: "The Something Extra", he: "הדבר הנוסף", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 4", note: "האנרגיה, ההתלהבות והכיף שעובדים בוחרים להביא לעבודה מעבר לביצוע הטכני של המשימה." },
  { en: "Empowerment", he: "העצמה", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 6", note: "מצב הכולל משמעות, אוטונומיה, תחושת מסוגלות ויכולת השפעה." },
  { en: "Theory X", he: "תיאוריית X", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 6", note: "תפיסה ניהולית שמניחה שאנשים עצלים ונוטה למיקרו-ניהול ופיקוח הדוק." },
  { en: "Theory Y", he: "תיאוריית Y", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 6", note: "תפיסה ניהולית שמניחה שאנשים שואפים לאחריות ולכן מאפשרת אוטונומיה והעצמה." },
  { en: "Choose Your Attitude", he: "בחר את הגישה שלך", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 7", note: "עיקרון ב-FISH!: גם כשהמשימה קשה, לעובד יש בחירה בגישה שהוא מביא." },
  { en: "Be Present", he: "להיות נוכח", source: "materials.html#fish-empowerment", sourceNote: "השלמה מקיפה, עמוד 7", note: "עיקרון ב-FISH!: נוכחות מלאה ותשומת לב מלאה מול אדם, לקוח או חבר צוות." },
  { en: "Schein Iceberg Model", he: "מודל הקרחון של שיין", source: "materials.html#schein-culture", sourceNote: "השלמה מקיפה, עמוד 8", note: "מודל תרבות ארגונית בשלוש רמות: ארטיפקטים גלויים, ערכים מוצהרים והנחות יסוד עמוקות." },
  { en: "Artifacts", he: "ארטיפקטים / התנהגויות גלויות", source: "materials.html#schein-culture", sourceNote: "השלמה מקיפה, עמוד 8", note: "הרמה הגלויה של תרבות ארגונית: סמלים, טקסים, שפה, לבוש והתנהגויות נראות." },
  { en: "Espoused Values", he: "ערכים מוצהרים", source: "materials.html#schein-culture", sourceNote: "השלמה מקיפה, עמוד 8", note: "הערכים שהארגון אומר שהוא מאמין בהם ומציג כלפי פנים וחוץ." },
  { en: "Basic Assumptions", he: "הנחות יסוד", source: "materials.html#schein-culture", sourceNote: "השלמה מקיפה, עמוד 8", note: "אמונות עומק לא תמיד מודעות שמפעילות בפועל את דפוסי ההתנהגות בארגון." },
  { en: "Devil's Advocate", he: "פרקליט השטן", source: "materials.html#norm-relevance", sourceNote: "השלמה מקיפה, עמוד 8", note: "כלי נגד Groupthink - חשיבת קבוצה: מינוי אדם שתפקידו לערער, לשאול שאלות ולהציג התנגדויות." }
];
...
const scenarios = [
  ...
  {
    title: "עבודה גלובלית, בעיה צוותית",
    text: "ארגון ישראלי נותן שירות ללקוחות באירופה עם צוות פיתוח בארץ, תמיכה בהודו ומנהל מוצר שעובד מרחוק. הבעיה אינה רק טכנית: מידע עובר בין אזורי זמן, החלטות מתקבלות בלי שכל הצדדים מעודכנים, והלקוח מצפה למענה אחיד.",
    best: "לזהות שזה בדיוק ההקשר של שיעור 1: Globalization - גלובליזציה, Technology - טכנולוגיה ו-Flat Organizations - ארגונים שטוחים יוצרים צורך בצוותים עם מטרה משותפת, תיאום ותלות הדדית.",
    why: "שיעור 1 מסביר שהצורך בצוותים נובע ממורכבות עולם העבודה המודרני, ולא רק מהרצון לחלק משימות בין אנשים."
  },
  {
    title: "מומחים שמגישים המלצה, לא מבצעים",
    text: "הנהלת הארגון מקימה צוות של מומחי HR, משפט, תפעול וכספים כדי לנתח בעיית שחיקה ולהגיש המלצות. הצוות לא אמור להפעיל את התוכנית בעצמו, אלא להציג חלופות והשלכות.",
    best: "לזהות Advice / Consulting Team - צוות ייעוץ. זהו צוות מומחים שמנתח סוגיה מורכבת ומגיש המלצות או חוות דעת, ולא צוות טקטי או צוות עבודה שוטף.",
    why: "ההשלמה מוסיפה צוות ייעוץ כסוג צוות נפרד שממוקד במחקר, ניתוח והמלצות."
  },
  {
    title: "עבודה שוחקת עם אנרגיה אחרת",
    text: "צוות שירות עובד במשימות חוזרות ושוחקות. המנהלת לא יכולה לשנות את כל תנאי העבודה, אבל היא רוצה ליצור נוכחות טובה יותר מול לקוחות, יותר משמעות ותחושת השפעה לעובדים.",
    best: "לשלב FISH! - פילוסופיית הדג עם Empowerment - העצמה: לבחור גישה, להיות נוכחים, לעשות ללקוח את היום, ולתת לעובדים אוטונומיה, משמעות ויכולת השפעה.",
    why: "ההשלמה מדגישה שהדבר הנוסף הוא האנרגיה והגישה שהעובדים בוחרים להביא, לצד העצמה אמיתית."
  },
  {
    title: "הערכים יפים, ההתנהגות אחרת",
    text: "על הקיר כתוב 'אנחנו מעודדים ביקורת', אבל בפועל מי שמעלה התנגדות בישיבה מקבל מבטים קרים והדיון נסגר במהירות. עובדים חדשים לומדים מהר שלא כדאי לשאול יותר מדי.",
    best: "להשתמש ב-Schein Iceberg Model - מודל הקרחון של שיין: הערך המוצהר הוא ביקורת, אבל הנחת היסוד והנורמה בפועל הן ציות והרמוניה. צריך לחשוף את הפער ולעודד Devil's Advocate - פרקליט השטן.",
    why: "ההשלמה מדגישה שההתנהגות בשטח נקבעת לעיתים לפי הנחות יסוד ונורמות, לא לפי הערכים המוצהרים."
  }
];
...
const topicModules = [
  {
    ...
    cue: "תיקי עובדים",
    topics: ["הגדרת צוות", "קבוצה לעומת צוות", "סינרגיה", "תנאים לעבודת צוות", "פרמטרים להשוואת צוותים", "עולם העבודה המודרני"],
    ...
    learn: [
      ...
      { text: "שיעור 1 מסביר שהצורך בצוותים נובע מ-Globalization - גלובליזציה, Technology - טכנולוגיה, תחרות, חדשנות וארגונים שטוחים.", source: "materials.html#modern-work" },
  ...
  },
  {
    ...
    cue: "מנורת החלטות",
    topics: ["3E", "לכידות וביטחון", "Groupthink", "לכידות וביקורת", "העצמה", "FISH"],
    ...
    learn: [
      ...
      { text: "Empowerment - העצמה כוללת משמעות, אוטונומיה, מסוגלות והשפעה; FISH! - פילוסופיית הדג מוסיפה בחירה בגישה ונוכחות.", source: "materials.html#fish-empowerment" }
    ],
  ...
  },
  {
    ...
    topics: ["סוגי צוותים", "צוות ייעוץ", "מידת שיתוף פעולה"],
    ...
    learn: [
      ...
      { text: "Advice / Consulting Team - צוות ייעוץ מנתח סוגיה ומגיש המלצות, בלי להיות צוות ביצוע שוטף.", source: "materials.html#advice-team" },
      { text: "Degree of Cooperation - מידת שיתוף פעולה עוזרת להבין אם נדרש סנכרון בזמן אמת או רק אינטגרציה בסוף.", source: "materials.html#team-comparison" }
    ],
  ...
  },
  {
    ...
    cue: "תג מנהל",
    topics: ["זהות חברתית", "יצירת זהות", "ייצוג חברתי", "ייצוגים חברתיים", "נורמות", "צרכים פסיכולוגיים", "עזיבה רגשית", "תרבות ארגונית"],
    ...
    learn: [
      ...
      { text: "Schein Iceberg Model - מודל הקרחון של שיין מבחין בין Artifacts - ארטיפקטים, Espoused Values - ערכים מוצהרים ו-Basic Assumptions - הנחות יסוד.", source: "materials.html#schein-culture" }
    ],
...
function sourceForTopic(topic) {
  ...
  const directSources = {
    ...
    "צוות ייעוץ": "materials.html#advice-team",
    "מידת שיתוף פעולה": "materials.html#team-comparison",
